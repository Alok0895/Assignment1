...
The perpendicular from the origin to the line \begin{align}\myvec{-m&1}\vec{x} = c\notag\end{align}\\ meets it at the point  $\vec{P}$ = \myvec{-1\\2} .\\find the value of m and c .
...
\\\implies(-1+2m) &= 0\notag\\
\implies m&=\frac{1}{2}\notag\\
\implies m &=0.5\label{eq1}
\end{align}
 now the line
 \begin{align}\myvec{-m&1}\vec{x}&=c\notag\end{align} meets it at the point
 $\vec{P}$=\myvec{-1\\2}\notag and using the value of m from \ref{eq1} we get,
\begin{align} 
\myvec{-0.5&1}\vec{P} &=c\notag\\
